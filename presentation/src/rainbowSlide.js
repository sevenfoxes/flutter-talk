...
import { getStyles } from 'spectacle/src/utils/base';
import {
  SlideContent,
  SlideContainer,
  SlideContentWrapper
} from 'spectacle/src/components/slide-components';
import stepCounter from 'spectacle/src/utils/step-counter';
import { addFragment } from 'spectacle/src/actions';

class RainbowSlide extends React.PureComponent {
  constructor() {
    super(...arguments);
...
RainbowSlide.childContextTypes = {
